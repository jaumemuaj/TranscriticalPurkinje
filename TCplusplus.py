...
def timestep(params: Params, state: State, stim: Stim, dt: float):
    ...
    eps_z   = params.eps_z0 - params.Deltaeps_z/(1+exp(-params.l*(zeff-params.eta_z*(params.zmax+(jnp.where(I > params.Iint, 1, 0)*params.chi*(I-params.Iint))))))
...
def simulation(dict_params,PF=(0,0,0),CF=0,isi=0,plots=True):
    ...
    traces['pauses']=pauses; traces['freq']=freq
